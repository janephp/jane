...
/**
 * @deprecated NormalizerArray is deprecated since 1.4 and will be removed in 2.0, please use Joli\Jane\Runtime\JsonSchema.Normalizer\ArrayDenormalizer instead.
 */
