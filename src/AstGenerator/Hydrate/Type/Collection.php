...
namespace Joli\Jane\Generator\Hydrate\Type;

use Joli\Jane\AstGenerator\AstGeneratorInterface;
use Joli\Jane\AstGenerator\UniqueVariableScope;
use Joli\Jane\AstGenerator\Exception\MissingContextException;
...
class Collection implements AstGeneratorInterface
{
    ...
    /** @var AstGeneratorInterface AstGenerator for the value of the collection */
     ...
     *
     * @param AstGeneratorInterface $subValueTypeGenerator AstGenerator for the value of the collection
    ...
    {
        if (!($object instanceof Type) || !$object->isCollection()) {
