...
namespace Joli\Jane\AstGenerator\Normalizer;
...
/**
 * Generate a JsonSchema.Normalizer given a Class.
 *
...
class Normalizer implements AstGeneratorInterface
{
    ...
    public function generate($object, array $context = array())
    {
        ...
        if (!isset($context['short_class_name'])) {
            ...
            $context['short_class_name'] = $reflectionClass->getShortName().'JsonSchema.Normalizer';
        }
